...
import { MAX_ATTACHMENTS_SIZE, STUDENT_SITUATIONS, validateApplication } from "./application-validation";
...
describe("validateApplication", () => {
	...
	it("rejects unsupported student situations", () => {
		expect(validateApplication({ ...validPayload(), studentSituation: "Iná skupina" })).toEqual({
			success: false,
	...
	it("requires literal boolean privacy consent", () => {
		expect(validateApplication({ ...validPayload(), personalDataConsent: "true" })).toEqual({
			success: false,
