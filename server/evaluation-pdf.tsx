		...
		>
			<Page size="A4" margin={{ top: 38, right: 42, bottom: 42, left: 42 }}>
				...
				<View style={{ backgroundColor: "#f1f6fb", borderRadius: 6, padding: 13, marginBottom: 16 }}>
					<Text style={{ fontSize: 8, color: "#60758a", textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 4 }}>Žiak</Text>
				...
				{data.categories.map((category, index) => (
					<View
						...
						style={{ borderWidth: 1, borderColor: "#d7e0e8", borderRadius: 5, marginBottom: 8, overflow: "hidden" }}
					>
				...
				<View
					style={{
						flexDirection: "row",
						alignItems: "center",
						backgroundColor: met ? "#e8f6ed" : "#fdecec",
						borderWidth: 1,
						borderColor: met ? "#63ad78" : "#d36b6b",
						borderRadius: 6,
						padding: 13,
						marginTop: 6,
					}}
				>
					<View style={{ flexGrow: 1 }}>
						...
						<Text style={{ fontSize: 14, fontWeight: "bold", color: met ? "#245c35" : "#7c2929" }}>
							{met ? "Kritérium splnené" : "Kritérium nesplnené"}
						</Text>
					</View>
					<Text style={{ fontSize: 22, fontWeight: "bold", color: met ? "#245c35" : "#7c2929" }}>{`${total}/50`}</Text>
				</View>

				<Text style={{ marginTop: 16, textAlign: "center", fontSize: 8, color: "#8a98a6" }}>
					Interný dokument školy - systém hodnotenia prihlášok Erasmus+
				</Text>
			</Page>
		</Document>
	);
