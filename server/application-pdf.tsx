	...
	return (
		<Document title="Prihláška Erasmus+" author="SOŠ technológií a remesiel">
			<Page size="A4" margin={48}>
				...
				>
					<Text style={{ fontSize: 10, color: "#1a6faa" }}>Stredná odborná škola technológií a remesiel, Ivanská cesta 21, 820 16 Bratislava</Text>
				</View>
				...
				<View style={{ textAlign: "center", marginBottom: 24 }}>
					<Text style={{ fontSize: 10, color: "#666" }}>The Application for the Erasmus+ project in the 2026/2027 school year</Text>
				</View>

				{/* Form fields */}
				<View style={row}>
					<Text style={{ ...label, width: 200 }}>Meno a priezvisko / Name and surname:</Text>
					<Text style={value}>{data.name}</Text>
				</View>

				<View style={row}>
					<Text style={{ ...label, width: 200 }}>Dátum narodenia / Date of Birth:</Text>
				...
				<View style={row}>
					<Text style={{ ...label, width: 200 }}>Adresa bydliska / Address:</Text>
				...
				>
					...
					<Text style={{ fontSize: 10, fontWeight: "bold", marginTop: 5 }}>Súhlas udelený: Áno</Text>
				</View>

				{/* Footer */}
				<View style={{ marginTop: 20, textAlign: "center" }}>
					<Text style={{ fontSize: 9, color: "#999" }}>Uvedené informácie sú určené pre interné potreby školy</Text>
				</View>
			</Page>
		</Document>
	);
