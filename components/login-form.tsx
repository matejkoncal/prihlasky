	...
	return (
		<Box
			...
			sx={{
				...
				alignItems: "center",
				background:
					"radial-gradient(circle at 8% 12%, rgba(73,181,207,.16), transparent 28%), linear-gradient(145deg, #eef4f9 0%, #f8fafc 55%, #eaf2f8 100%)",
				py: { xs: 3, sm: 5 },
			}}
		>
			<Container maxWidth="md">
				...
				>
					...
					>
						...
						<Box
							aria-hidden
							sx={{ position: "absolute", width: 170, height: 170, borderRadius: "50%", bgcolor: "rgba(85,214,222,.1)", left: -75, bottom: -80 }}
						/>
						...
						<Stack direction="row" spacing={1.75} sx={{ position: "relative", alignItems: "center" }}>
							...
							<Box>
								...
								<Typography variant="body2" sx={{ color: "rgba(255,255,255,.68)", mt: 0.35 }}>
						...
						<Box sx={{ position: "relative", mt: { xs: 4, md: 8 }, maxWidth: 330 }}>
							<Typography variant="overline" sx={{ color: "#78d9e2", fontWeight: 800, letterSpacing: ".14em" }}>
								Erasmus+
							</Typography>
							<Typography variant="h4" component="p" sx={{ fontWeight: 800, lineHeight: 1.18, mt: 0.5 }}>
					...
					<Box sx={{ display: "flex", flexDirection: "column", justifyContent: "center", p: { xs: 3, sm: 5, md: 6 }, bgcolor: "common.white" }}>
						...
						<Typography variant="h4" component="h1" sx={{ fontWeight: 850, color: "#102f4a", mt: 0.35 }}>
							Prihlásenie
						</Typography>
						...
						<Box component="form" onSubmit={submit} sx={{ display: "grid", gap: 2.25 }}>
							...
							<Button
								...
								sx={{ mt: 0.5, minHeight: 50, borderRadius: 2, fontWeight: 800, boxShadow: "0 8px 20px rgba(25,118,210,.22)" }}
							>
