			...
			<Container maxWidth="sm" sx={{ py: { xs: 2, sm: 4 } }}>
				...
				>
					...
					<Box sx={{ textAlign: "center", mb: 3 }}>
						<Box component="img" src={sosLogo} alt="SOŠ technológií a remesiel" sx={{ height: 70, mx: "auto", mb: 1, display: "block" }} />
						...
						>
							<Box component="img" src={erasmusLogo} alt="Erasmus+" sx={{ height: 40 }} />
							<Box component="img" src={saiacLogo} alt="SAAIC" sx={{ height: 40 }} />
						</Box>
					...
					<Typography variant="subtitle2" align="center" color="text.secondary" sx={{ mb: 0.5 }}>
						pre školský rok 2026/2027
					</Typography>
					<Typography variant="caption" align="center" color="text.disabled" sx={{ mb: 3, display: "block" }}>
						The Application for the Erasmus+ project in the 2026/2027 school year
					</Typography>

					{success ? (
						<Paper variant="outlined" sx={{ p: 4, textAlign: "center", bgcolor: "success.50" }}>
							<Typography variant="h6" sx={{ fontWeight: 700, mb: 1 }}>
								Prihláška bola úspešne odoslaná.
							</Typography>
							<Typography color="text.secondary">Potvrdenie sme odoslali na e-mailovú adresu {confirmationEmail}.</Typography>
						</Paper>
					) : (
						<>
							{error && (
							...
							<Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 2.5 }}>
								<TextField label="Meno a priezvisko / Name and surname" name="name" required fullWidth value={form.name} onChange={handleChange} />
								...
								>
									<TextField
										...
										onChange={handleChange}
									/>
									<TextField label="Odbor / Field of study" name="odbor" required fullWidth select value={form.odbor} onChange={handleChange}>
										{ODBORY.map(o => (
								...
								<TextField label="Ulica a číslo / Street" name="address1" required fullWidth value={form.address1} onChange={handleChange} />
								...
								>
									<TextField label="PSČ a mesto / ZIP & City" name="address2" fullWidth value={form.address2} onChange={handleChange} />
									<TextField label="Krajina / Country" name="address3" fullWidth value={form.address3} onChange={handleChange} />
								</Box>
								...
								>
									<TextField label="Telefón / Phone" name="phone" type="tel" required fullWidth value={form.phone} onChange={handleChange} />
									<TextField label="Email" name="email" type="email" required fullWidth value={form.email} onChange={handleChange} />
								</Box>

								<FormControl required>
									<FormLabel id="student-situation-label">Vyberte možnosť, ktorá najlepšie vystihuje Vašu situáciu:</FormLabel>
									<RadioGroup aria-labelledby="student-situation-label" name="studentSituation" value={form.studentSituation} onChange={handleChange}>
										<FormControlLabel
										...
										<FormControlLabel
											...
											control={
												<Radio
													...
													slotProps={{
														input: {
															"aria-label": "Žiak zo sociálne znevýhodneného prostredia",
														},
													}}
												/>
											}
										...
										<FormControlLabel
											...
											control={
												<Radio
													...
													slotProps={{
														input: {
															"aria-label": "Nepatrím do žiadnej z uvedených skupín",
														},
													}}
												/>
											}
								...
								<Typography variant="body2" color="text.secondary" sx={{ lineHeight: 1.7 }}>
									Svojím odoslaním potvrdzujem prihlášku do výberového konania na projekt Erasmus+.
									<br />
								...
								<Paper variant="outlined" sx={{ p: 2, bgcolor: "grey.50" }}>
									...
									<Button component="label" variant="outlined" size="small" startIcon={<AttachFileIcon />} sx={{ textTransform: "none", mb: 1 }}>
										{motivationLetter ? motivationLetter.name : "Motivačný list / Motivation letter"}
										<input
											type="file"
											hidden
